...
const PillItem = ({ icon, label, isActive, isHovered, isPressed, isDark, onClick, onMouseEnter, onMouseLeave, onMouseDown, onMouseUp }) => (
    <Box
        onClick={onClick}
...
const FloatingPillNav = ({ items, currentPath, onNavigate, actions = [], searchRootDir, onSearchResultClick }) => {
            ...
            <GlobalSearch
                ...
                renderTrigger={(openSearch) => (
                    <PillItem
                        ...
                        onMouseLeave={() => { setHoveredAction(null); setPressedAction(null); }}
