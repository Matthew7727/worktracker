...
export const createNote = (options = {}) => ({
  ...
  meetingTitle: options.meetingTitle || null,
...
const noteFromFile = (filePath, raw) => {
  ...
  return {
    ...
    meetingId: frontmatter.meetingId || null,
    meetingTitle: frontmatter.meetingTitle || null,
...
const noteToFileContent = (note) =>
  stringifyMarkdown(note.content || '', {
    ...
    meetingTitle: note.meetingTitle || null,
