...
export const docsContentStyles = {
    ...
    '& p': { fontSize: '1.1rem', lineHeight: 1.6, mb: 3, opacity: 0.8, color: 'text.primary' },
    '& ul, & ol': { mb: 3, pl: 4, color: 'text.primary' },
    '& li': { mb: 1.5, fontSize: '1.1rem', opacity: 0.8 },
    '& code': { bgcolor: 'action.hover', px: 1, borderRadius: '4px', fontWeight: 700, fontFamily: '"JetBrains Mono", monospace' },
    '& blockquote': { borderLeft: '5px solid', borderColor: 'primary.main', pl: 3, py: 1, my: 3, bgcolor: 'action.hover', fontWeight: 600, color: 'text.primary' }
};
