  ...
  return (
    <Box>
      ...
      <Typography variant="caption" sx={{ fontWeight: 700, opacity: 0.6 }}>
        ...
        {targetPct != null && (
          <Typography component="span" variant="caption" sx={{ fontWeight: 700, opacity: 0.5, ml: 1 }}>
            · target {targetPct}%
          </Typography>
        )}
      </Typography>
...
const sectionLabel = { fontWeight: 900, mb: 3, textTransform: 'uppercase', letterSpacing: 1, opacity: 0.7 }
...
const StreamAlignment = ({ entries, stats, utilisationTarget, loading }) => (
  ...
  >
    ...
    <Box sx={{ flex: 2, width: '100%' }}>
      <Typography variant="h6" sx={sectionLabel}>Weekly Intensity</Typography>
    ...
    <Box sx={{ flex: 1, width: '100%' }}>
      <Typography variant="h6" sx={sectionLabel}>Stream Alignment</Typography>
